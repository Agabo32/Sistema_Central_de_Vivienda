...
# Leer el archivo CSV
df = pd.read_csv('C:/Users/USER/Pictures/Archivo/IRIBARREN(GUERRERA ANA SOTO).csv', sep=';', header=None, names=['Comunidad'])
...
df_sin_duplicados.to_csv('IRIBARREN(GUERRERA ANA SOTO).csv', index=False, sep=';')
