...
<head>
    ...
    <style>
        ...
        .login-left {
            background: linear-gradient(135deg, #0D36EEFF, rgba(#0D36EEFF));
            color: white;
            padding: 3rem;
            display: flex;
        ...
        .login-left::before {
            ...
            width: 200%;
            height: 200%;
            background: radial-gradient(circle, rgba(0,0,0,0) 0%, #0D36EEFF 70%);
        ...
        /* Botón con efecto */
        .btn-animado {
            background: linear-gradient(45deg, #0D36EEFF, #0D36EEFF);
            border: none;
            color: white;
            padding: 12px 25px;
            font-size: 18px;
